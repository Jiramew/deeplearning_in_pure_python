...
from cnn_simple.util.randn import Randn
from cnn_simple.util.constant import INIT_XAVIER, INIT_ZEROS, ACTIVATION_RELU, \
    ACTIVATION_TANH, \
    ACTIVATION_SOFTMAX
